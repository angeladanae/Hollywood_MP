    ...
    @endif
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="/admin/HorrorMovies/delete" method="POST">
                @csrf
                @method("DELETE")
                <input type="hidden" name="movieid" id="movieid" value="{{ $HorrorMovies->_id }}">
                    <div class="form-group">
                        <label for="film">Film name</label>
                        <input type="text" class="form-control" id="film" name="film" value="{{ $HorrorMovies->film}}" disabled>
                    </div>
                    <div class="form-group">
                    <label for ="genre"> genre </label>
                    <textarea class= "form-control" name="genre" id="genre" cols="30" rows="3" value="{{ $HorrorMovies->genre }}" disabled></textarea>
                    </div>
                    <div class="form-group">
                    <label for ="grade"> Rotten Tomatoes </label>
                    <textarea class= "form-control" name="grade" id="grade" cols="30" rows="3" value="{{ $HorrorMovies->grade }}" disabled></textarea>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select type="text" class="form-control" id="year" name="year" value="{{ $HorrorMovies->year }} disabled">
